      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex-1 bg-white border-2 border-blue-300 p-4 rounded-lg font-mono text-gray-900 break-all">
                      {formatPixKey(pixKey?.key, pixKey?.type)}
                    </div>
                    <button
                      onClick={copyPixKey}
        ...
        {order?.paymentMethod === "pix" && (
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-2xl p-8 mb-6">
            <div className="text-center mb-6">
              ...
              <a
                href={`https://wa.me/${formatWhatsAppNumber(store?.phone)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-white hover:bg-green-50 rounded-lg p-4 mb-6 transition-colors border border-green-200 hover:border-green-400"
              >
                <p className="text-sm text-gray-600 mb-2">WhatsApp da Loja:</p>
                <p className="text-2xl font-bold text-green-600 hover:text-green-700 flex items-center justify-center">
                  <svg
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-2xl p-8 mb-6">
            <div className="text-center mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-white hover:bg-blue-50 rounded-lg p-4 mb-6 transition-colors border border-blue-200 hover:border-blue-400"
              >
                <p className="text-sm text-gray-600 mb-2">WhatsApp da Loja:</p>
                <p className="text-2xl font-bold text-blue-600 hover:text-blue-700 flex items-center justify-center">
                  <svg
                    className="w-6 h-6 mr-2"
                    fill="currentColor"
                    viewBox="0 0 24 24"
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-300 rounded-2xl p-8 mb-6">
            <div className="text-center mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-white hover:bg-orange-50 rounded-lg p-4 mb-6 transition-colors border border-orange-200 hover:border-orange-400"
              >
                <p className="text-sm text-gray-600 mb-2">WhatsApp da Loja:</p>
                <p className="text-2xl font-bold text-orange-600 hover:text-orange-700 flex items-center justify-center">
                  <svg
                    className="w-6 h-6 mr-2"
                    fill="currentColor"
                    viewBox="0 0 24 24"
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            Minhas compras na loja {store?.name}
          </Link>
        </div>
      </main>
