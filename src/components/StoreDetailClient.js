...
import AssemblableProductModal from "./AssemblableProductModal";
...
export default function StoreDetailClient({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row items-center gap-2 sm:gap-4 mt-4">
              {/* Botão Minhas Compras / Minhas Vendas */}
              {session && (
                <Link
                  href={
                    isOwner
                ...
                >
                  ...
                  <span className="hidden sm:inline">
                    {isOwner ? "Minhas Vendas" : "Minhas Compras"}
                  </span>
                  <span className="sm:hidden">
                    {isOwner ? "Pedidos" : "Compras"}
                  </span>
                </Link>
              )}
      ...
      {/* Carrinho Flutuante */}
      {showFloatingCart && cartItemCount > 0 && !isOwner && (
